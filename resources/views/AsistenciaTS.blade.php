                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <label for="" class="form-label">DNI TS</label>
                                    <input type="text" class="form-control" id="DNITS" name="DNITS">
                                </div>
                                <div class="col-lg-4">
                                    <label for="" class="form-label">Nombre TS</label>
                                    <input type="text" class="form-control" id="NombreTS" name="NombreTS">
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <label for="" class="form-label">DNI TS</label>
                                    <input type="text" class="form-control" id="DNITSe" name="DNITSe">
                                </div>
                                <div class="col-lg-4">
                                    <label for="" class="form-label">Nombre TS</label>
                                    <input type="text" class="form-control" id="NombreTSe" name="NombreTSe">
                                </div>
                                <div class="col-lg-4">
                                    <label for="" class="form-label">Fecha Registro</label>
...
@section('script_table_ajax')
    <script>
        ...
        $(document).on("click",".btnEditarNombre",function(e){
            ...
            $.ajax({
                type: "GET",
                url: "EditarRegistroNombre/"+id,
                dataType: "json",
                success: function (response) {
                    $("#DNITSe").val(response[0].ts_DNI);
                    $("#NombreTSe").val(response[0].ts_Nombre);
